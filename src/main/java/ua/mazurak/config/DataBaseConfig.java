...
@EnableJpaRepositories(basePackages = "ua.mazurak.repository")
@ComponentScan(basePackages = {"ua.mazurak.repository","ua.mazurak.service"})
...
public class DataBaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() throws PropertyVetoException {
		...
		emf.setPackagesToScan(new String[] {"ua.mazurak.entity"}); // Entity package
